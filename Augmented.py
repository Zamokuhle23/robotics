...
imgStacked = cv2.imread('sondos.jpg')
cap = cv2.VideoCapture(0)
imgTarget = cv2.imread('sondo.jpg')
myVid = cv2.VideoCapture('vid.mp4')
...
while True:
    ...
    for m,n in matches:
        ...
        if len(good) > 20:
            ...
            imgStacked = stackImages(([imgWebcam, imgVideo], [imgFeatures, imgWarp, imgAug]), 0.5)
